              ...
              <Col className="ml-auto" lg="6" md="6" sm="7" xs="12">
                <div className="info info-horizontal">
                  ...
                  <div className="description">
                    ...
                    <p>
                      Spend less time planning trades, try our
                      remarkably power tools. Everything you need in a
                      single dashboard.
                    </p>
                  </div>
                </div>
                <div className="info info-horizontal">
                  ...
                  <div className="description">
                    ...
                    <p>
                      Efficiently plan your strategy accross 
                      stocks, crypto, and forex. Quickly maximize profits and
